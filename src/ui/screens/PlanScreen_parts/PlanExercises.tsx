...
export const PlanExercises: React.FC = () => {
  const exerciseGroups = React.useMemo(() => {
    ...
    for (const ex of EXERCISE_CATALOG) {
      ...
      groups[ex.group].push(ex as any); // Assuming EXERCISE_CATALOG has items compatible with Exercise
    }
    return groups;
  }, []);
  ...
  return (
    <div className="plan-exercises">
      {Object.entries(exerciseGroups as Record<string, Exercise[]>).map(([group, exercises]) => (
